...
- **Bash** — rm /Users/ckausik/Documents/vault-demo/tmp_useless_test_file.txt && echo "Deleted successfully"
...
On it — writing a temporary file and then cleaning it up.Let me find the vault directory first.✅ File written. Now deleting it:Done! Wrote `tmp_useless_test_file.txt` to the vault root and then deleted it. Everything's clean — no trace left behind.
