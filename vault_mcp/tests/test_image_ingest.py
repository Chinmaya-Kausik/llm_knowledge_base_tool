...
from vault_mcp.tools.ingest import _download_images
...
def test_download_images_rewrites_urls():
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        with patch("vault_mcp.tools.ingest.urllib.request.urlretrieve") as mock_dl:
...
def test_download_images_failure_preserves_original():
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        with patch("vault_mcp.tools.ingest.urllib.request.urlretrieve", side_effect=Exception("Network error")):
