...
function fileIcon(name) {
  ...
  const map = { md: 'md', py: 'py', js: 'js', ts: 'js', jsx: 'js', tsx: 'js', json: 'json', yaml: 'yaml', yml: 'yaml', tex: 'tex', bib: 'bib', pdf: 'pdf', png: 'img', jpg: 'img', jpeg: 'img', gif: 'img', svg: 'img', sh: 'js', css: 'js', html: 'js', toml: 'toml', csv: 'csv', ipynb: 'ipynb', r: 'r', sql: 'sql', txt: 'txt', xml: 'xml', c: 'c', cpp: 'cpp', h: 'c', rs: 'rs', go: 'go' };
