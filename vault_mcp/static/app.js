...
const _fileIcons = {
  folder: `<svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="fg" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#5db0f7"/><stop offset="100%" stop-color="#2b7de9"/></linearGradient></defs><path d="M2 6a2 2 0 0 1 2-2h4.5l2 2H20a2 2 0 0 1 2 2v1H2V6z" fill="#4a9af5"/><rect x="1" y="8" width="22" height="13" rx="2" fill="url(#fg)"/><rect x="1" y="8" width="22" height="3" rx="1" fill="#6bbfff" opacity="0.4"/></svg>`,
