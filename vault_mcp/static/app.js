...
const _fileIcons = {
  folder: `<svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="fback" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#3b94d4"/><stop offset="100%" stop-color="#2574b0"/></linearGradient><linearGradient id="ffront" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#92d8fc"/><stop offset="40%" stop-color="#72ccf4"/><stop offset="100%" stop-color="#5cb8e8"/></linearGradient></defs><path d="M5.5 19.8 C5.5 18.3 7 17 8.5 17 L18 17 C18 17 19 17 19.6 17.7 L21 19.3 C21.8 20.3 23 20.8 23 20.8 L44 20.8 C45.5 20.8 47 22 47 23.5 L47 43 C47 45 45.5 46.5 44 46.5 L8.5 46.5 C7 46.5 5.5 45 5.5 43 Z" fill="url(#fback)"/><rect x="4.5" y="25" width="43.5" height="22" rx="3.5" fill="#1a6aa8" opacity="0.12"/><rect x="4.5" y="24" width="43.5" height="22.5" rx="3.5" fill="url(#ffront)"/><rect x="4.5" y="24" width="43.5" height="22.5" rx="3.5" stroke="#4a9ac8" stroke-width="0.4" fill="none"/><rect x="9" y="43" width="34" height="1.2" rx="0.6" fill="#3888b8" opacity="0.25"/></svg>`,
