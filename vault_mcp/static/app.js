...
const _fileIcons = {
  folder: `<svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="fback" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#3b94d4"/><stop offset="100%" stop-color="#2574b0"/></linearGradient><linearGradient id="ffront" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#92d8fc"/><stop offset="40%" stop-color="#72ccf4"/><stop offset="100%" stop-color="#5cb8e8"/></linearGradient></defs><path d="M6 16 C6 14 7.5 12.5 9.5 12.5 L20 12.5 L20 12.5 C20 12.5 21 12.5 21.8 13.5 L23.5 15.5 C24.5 16.8 26 17 26 17 L43 17 C45 17 46.5 18.5 46.5 20.5 L46.5 43 C46.5 45 45 46.5 43 46.5 L9.5 46.5 C7.5 46.5 6 45 6 43 Z" fill="url(#fback)"/><rect x="5" y="20.5" width="42.5" height="27" rx="3.5" fill="#1a6aa8" opacity="0.12"/><rect x="5" y="19.5" width="42.5" height="27" rx="3.5" fill="url(#ffront)"/><rect x="5" y="19.5" width="42.5" height="27" rx="3.5" stroke="#4a9ac8" stroke-width="0.4" fill="none"/><rect x="9" y="43" width="34" height="1.2" rx="0.6" fill="#3888b8" opacity="0.25"/></svg>`,
