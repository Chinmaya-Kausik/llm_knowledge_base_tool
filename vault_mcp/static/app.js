...
const _fileIcons = {
  folder: `<svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="fg" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#3d8bfd"/><stop offset="100%" stop-color="#2768d4"/></linearGradient></defs><path d="M2 6a2 2 0 0 1 2-2h4.5l2 2H20a2 2 0 0 1 2 2v1H2V6z" fill="#1d6ce0"/><rect x="1" y="8" width="22" height="13" rx="2" fill="url(#fg)"/><line x1="1" y1="8.5" x2="23" y2="8.5" stroke="#1a5ab8" stroke-width="0.75"/><rect x="2" y="9" width="20" height="2" rx="0.5" fill="white" opacity="0.15"/></svg>`,
