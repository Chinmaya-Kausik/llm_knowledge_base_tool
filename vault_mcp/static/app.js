...
const _fileIcons = {
  folder: `<svg width="38" height="38" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="3" y="6" width="26" height="22" rx="2.5" fill="#2e8ad8"/><path d="M3 8.5A2.5 2.5 0 0 1 5.5 6H13c1 0 1.5.5 2 1.2l1 1.3H27a2.5 2.5 0 0 1 2.5 2.5H3V8.5z" fill="#2980c8"/><rect x="2.5" y="10.5" width="27" height="18" rx="2.5" fill="#6bbff0"/><rect x="2.5" y="10.5" width="27" height="3" rx="1" fill="#7fcdf5" opacity="0.6"/><rect x="4" y="25.5" width="24" height="1.5" rx="0.75" fill="#4daae0" opacity="0.5"/><rect x="2.5" y="10.5" width="27" height="18" rx="2.5" stroke="#4a9ad4" stroke-width="0.5" fill="none"/></svg>`,
