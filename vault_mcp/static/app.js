...
const _fileIcons = {
  folder: `<svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="fback" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#3b94d4"/><stop offset="100%" stop-color="#2574b0"/></linearGradient><linearGradient id="ffront" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#90d4fa"/><stop offset="40%" stop-color="#6ec6f0"/><stop offset="100%" stop-color="#58b4e4"/></linearGradient></defs><path d="M6 12 C6 9.5 8 7.5 10.5 7.5 L22 7.5 C22 7.5 23.5 7.5 24.5 9 L27 12.5 C28 14 29.5 15 29.5 15 L42 15 C44.5 15 46 17 46 19 L46 42 C46 44.5 44 46 42 46 L10 46 C7.5 46 6 44 6 42 Z" fill="url(#fback)"/><rect x="5" y="19" width="42" height="28" rx="4" fill="#1a6aa8" opacity="0.15"/><rect x="5" y="18" width="42" height="28" rx="4" fill="url(#ffront)"/><rect x="5" y="18" width="42" height="28" rx="4" stroke="#4a9ac8" stroke-width="0.5" fill="none"/><path d="M9 18.5 Q26 17 43 18.5" stroke="white" stroke-width="0.6" opacity="0.3" fill="none"/><rect x="9" y="42" width="34" height="1.5" rx="0.75" fill="#3888b8" opacity="0.3"/></svg>`,
