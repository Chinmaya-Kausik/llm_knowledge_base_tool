...
const _fileIcons = {
  folder: `<svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="fback" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#3b94d4"/><stop offset="100%" stop-color="#2574b0"/></linearGradient><linearGradient id="ffront" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#92d8fc"/><stop offset="40%" stop-color="#72ccf4"/><stop offset="100%" stop-color="#5cb8e8"/></linearGradient></defs><path d="M6 18 C6 16.5 7.5 15 9.5 15 L18 15 C18 15 19 15 19.6 15.8 L21 17.5 C21.8 18.5 23 19 23 19 L43 19 C45 19 46.5 20.5 46.5 22 L46.5 43 C46.5 45 45 46.5 43 46.5 L9.5 46.5 C7.5 46.5 6 45 6 43 Z" fill="url(#fback)"/><rect x="5" y="22.5" width="42.5" height="25" rx="3.5" fill="#1a6aa8" opacity="0.12"/><rect x="5" y="21.5" width="42.5" height="25" rx="3.5" fill="url(#ffront)"/><rect x="5" y="21.5" width="42.5" height="25" rx="3.5" stroke="#4a9ac8" stroke-width="0.4" fill="none"/><rect x="9" y="43" width="34" height="1.2" rx="0.6" fill="#3888b8" opacity="0.25"/></svg>`,
