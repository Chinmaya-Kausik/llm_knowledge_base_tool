...
const _fileIcons = {
  folder: `<svg width="38" height="38" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="3" y="5" width="18" height="15" rx="1.5" fill="#d0d8e8" opacity="0.5"/><path d="M3 7.5a1.5 1.5 0 0 1 1.5-1.5h4l1.5 1.5H19.5A1.5 1.5 0 0 1 21 9v0H3V7.5z" fill="#4a90d9"/><rect x="2.5" y="8.5" width="19" height="12" rx="1.5" fill="#5ba0e6"/><line x1="2.5" y1="9" x2="21.5" y2="9" stroke="#3a78c0" stroke-width="0.75"/></svg>`,
