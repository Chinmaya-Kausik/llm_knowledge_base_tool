...
7. Update topic indexes using loom:write_index — for each major topic cluster, write/update an index containing brief summaries of all related pages. These indexes are what makes Q&A work without RAG.
8. Commit changes with loom:auto_commit.
